...
- OLED- und Serial-Updates in `TIMING` sind bewusst getaktet, um Lastspitzen zu reduzieren:
  - OLED-Live-Zeit: alle `TIMING_OLED_UPDATE_MS` (aktuell 100 ms)
  - Timing-Logs: alle `TIMING_LOG_UPDATE_MS` (aktuell 160 ms)
