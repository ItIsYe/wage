...
static constexpr uint16_t PIXEL_COUNT = 77;    // Physische Segmentanzahl (COB-Strip, alle 12,5mm trennbar, 0,96m)
static constexpr uint8_t PIXEL_GROUP_SIZE = 3;                        // je 3 physische Pixel = 1 logische Gruppe
static constexpr uint16_t PIXEL_GROUPS = PIXEL_COUNT / PIXEL_GROUP_SIZE; // 25 Gruppen bei 77 Pixeln (2 Pixel ungenutzt am Ende)
